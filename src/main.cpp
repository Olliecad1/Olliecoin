...
uint256 hashGenesisBlock("0x67284a7cedd9a638dde1f42b59777f4a9c340fe9b3a5e8e84f5e870d13d3eb94");
...
const string strMessageMagic = "olliecoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 50 * 60 * 60; // olliecoin: 1 days
static const int64 nTargetSpacing = 300; // olliecoin: 5 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal olliecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "olliecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x67284a7cedd9a638dde1f42b59777f4a9c340fe9b3a5e8e84f5e870d13d3eb94");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Olliecoin is a cool cryptocurrency, Im Oliver Morris, 14 years old, Python Developer...";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1506171027; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 95860;

        if (fTestNet)
        {
            block.nTime    = 1506171027;
            block.nNonce   = 95860;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x0068b4b0286b80d7c18d05984113b8063339bfe065de2a6242be4738fede1122"));
