...
{
    resize(850, 550);
    setWindowTitle(tr("olliecoin") + " - " + tr("Wallet"));
#ifndef Q_WS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a olliecoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About olliecoin"), this);
    aboutAction->setToolTip(tr("Show information about olliecoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for olliecoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("Show/Hide &olliecoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the olliecoin window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("olliecoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("olliecoin client"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide olliecoin"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setPixmap(QIcon(icon).pixmap(STATUSOLLIE_ICONSIZE,STATUSOLLIE_ICONSIZE));
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to olliecoin network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(secs < 90*60 && count >= nTotalBlocks)
    {
        ...
        labelBlocksIcon->setPixmap(QIcon(":/icons/synced").pixmap(STATUSOLLIE_ICONSIZE, STATUSOLLIE_ICONSIZE));
...
void BitcoinGUI::setMining(bool mining, int hashrate)
{
    if (mining)
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_active").pixmap(STATUSOLLIE_ICONSIZE,STATUSOLLIE_ICONSIZE));
        labelMiningIcon->setToolTip(tr("Mining olliecoin at %1 hashes per second").arg(hashrate));
    }
    else
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_inactive").pixmap(STATUSOLLIE_ICONSIZE,STATUSOLLIE_ICONSIZE));
        labelMiningIcon->setToolTip(tr("Not mining olliecoin"));
    }
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid olliecoin address or malformed URI parameters."));
    }
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelEncryptionIcon->setPixmap(QIcon(":/icons/lock_open").pixmap(STATUSOLLIE_ICONSIZE,STATUSOLLIE_ICONSIZE));
    ...
    case WalletModel::Locked:
        labelEncryptionIcon->show();
        labelEncryptionIcon->setPixmap(QIcon(":/icons/lock_closed").pixmap(STATUSOLLIE_ICONSIZE,STATUSOLLIE_ICONSIZE));
